...
/*  2 */ _CFFI_OP(_CFFI_OP_POINTER, 6), // char *
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION, 1), // long()(void)
...
static const struct _cffi_global_s _cffi_globals[] = {
  { "loadJson", (void *)_cffi_f_loadJson, _CFFI_OP(_CFFI_OP_CPYTHON_BLTN_N, 4), (void *)_cffi_d_loadJson },
...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit_pyBackend(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit_pyBackend(void) { return NULL; }
#  else
     initpyBackend(void) { }
#  endif
#  endif
...
PyMODINIT_FUNC
PyInit_pyBackend(void)
{
  return _cffi_init("pyBackend", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
initpyBackend(void)
{
  _cffi_init("pyBackend", 0x2601, &_cffi_type_context);
}
#endif
